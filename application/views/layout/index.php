	...
	<div class="wrapper theme-1-active pimary-color-green">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<?php if ($this->session->userdata('user_level')==1): ?>
						<li>
							<a class="<?=($hal=='admin')?'active':''?>" href="<?=base_url('admin')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="fa fa-key mr-20"></i><span class="right-nav-text">Daftar Admin</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>
						<li>
							<a class="<?=($hal=='menu')?'active':''?>"  href="<?=base_url('menu')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class=" fa fa-cutlery mr-20"></i><span class="right-nav-text">Daftar Menu</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>

						<li>
							<a class="<?=($hal=='pesanan')?'active':''?>"  href="<?=base_url('pesanan')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="fa fa-cart-arrow-down mr-20"></i><span class="right-nav-text">Daftar Pesanan</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>

						<li>
							<a class="<?=($hal=='pelanggan')?'active':''?>" href="<?=base_url('pelanggan')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="icon-user mr-20"></i><span class="right-nav-text">Daftar Pelanggan</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>
						<li>
							<a class="<?=($hal=='penggunaan')?'active':''?>" href="<?=base_url('penggunaan')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="ti-wallet mr-20"></i><span class="right-nav-text">Penggunaan</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>
						<li>
							<a class="<?=($hal=='verifikasi')?'active':''?>" href="<?=base_url('verifikasi')?>" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="ti-check-box mr-20"></i><span class="right-nav-text">Verifikasi Pembayaran</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
						</li>
					<?php endif ?>
				</ul>
			</div>
			...
			<?php if (isset($validation)): ?>
				...
				<script type="text/javascript" src="<?=base_url('assets/js_tambahan/'.$validation)?>.js"></script>		
			<?php endif ?>
			...
			<?php if (isset($js_tambahan)): ?>
				...
				<script type="text/javascript" src="<?=base_url('assets/js_tambahan/'.$js_tambahan)?>.js"></script>
			<?php endif ?>
		</body>
