										...
										<div class="form-wrap">
											<form action="<?=base_url('register/validate')?>" method="POST" id="form-add">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="input-no_meter" placeholder="No Meter"  name="no_meter">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="input-alamat" name="alamat" placeholder="Alamat Lengkap"></textarea>
													<div class="help-block with-errors" id="error">
													</div>
												</div>
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputEmail_2">Jenis Daya  *</label>
													<select name="id_tarif" id="input-id_tarif" class="form-control">
														<option value="" style="display:none;">Pilih Tarif</option>
														<?php foreach ($tarif as $tarifs): ?>
															<option value="<?=$tarifs->id_tarif?>"><?=$tarifs->daya?> - Rp.<?=$tarifs->perkwh?>/kwh</option>
														<?php endforeach ?>
													</select>
													<div class="help-block with-errors" id="error">
												</div>
